        ...
        <div className="container-modern max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-body text-gray-400 max-w-2xl mx-auto mb-8">
              Your privacy is important to us. Read our policy below to understand how we collect, use, and protect your information.
            </p>
          </motion.div>
          <Card className="glass-dark border-white/10">
            ...
            <CardContent>
              <div className="text-gray-300 space-y-6 text-left">
                ...
                <p>For more information, contact us at privacy@admybrand.ai.</p>
              </div>
            </CardContent>
          </Card>
        </div>
