        ...
        <div className="container-modern max-w-3xl mx-auto">
          ...
          >
            <h1 className="text-display font-playfair text-white mb-6">
              GDPR <span className="text-gradient-primary">Compliance</span>
            </h1>
            <p className="text-body text-gray-400 max-w-2xl mx-auto mb-8">
              Learn how ADmyBRAND complies with the General Data Protection Regulation (GDPR).
            </p>
          </motion.div>
          <Card className="glass-dark border-white/10">
            ...
            <CardContent>
              <div className="text-gray-300 space-y-6 text-left">
                ...
                <p>For more information, contact us at gdpr@admybrand.ai.</p>
              </div>
            </CardContent>
          </Card>
        </div>
